...
/ClineteScript4.sh
```
Y con eso tendras toda la configuracion necesaria. Si quieres ver la guia completa o ir por los vagrant box, puedes encontrar la guia en el siguiente enlace 🔗 </br>
[Guia Completa ](https://juanfelipest.atlassian.net/l/c/XvQvY3B1)</br>
Los vagrant box los encontraras en el enlace 🔗 </br>
[Vagrant Boxes ](https://app.vagrantup.com/cfarinavalencia/)</br>
También encontras un artículo sobre los balanceos de carga en servidores de bases de datos en el siguiente enlace 🔗 </br>
[Artículo ](https://juanfelipest.atlassian.net/l/c/qcwqwL4V)</br>
